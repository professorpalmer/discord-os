...
Shared-desk materials for Discord OS (Puppetmaster-tier shareability).
...
| [board-catchup](board-catchup.md) | Wave 4 ADR/PR conflict Catch-up + digest schedules |
| [brain-lake](brain-lake.md) | Per-DRI brain bind + meat-proxy handoff cut |
